                ...
                children: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      for (var doc in docs) {
                        final data = doc.data() as Map<String, dynamic>;
                        totalMade += (data['quantity_made'] as num?)?.toInt() ?? 0;
                        totalSold += (data['quantity_sold'] as num?)?.toInt() ?? 0;
                        totalSurplus +=
                            (data['quantity_surplus'] as num?)?.toInt() ?? 0;
                      }
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: 4),
                                              Text(
                                                'Surplus: ${data['quantity_surplus'] ?? 0}',
                                                style: GoogleFonts.inter(
                                                  fontSize: 14,
                                                  color: const Color(
                                                    0xFFB0B0B0,
