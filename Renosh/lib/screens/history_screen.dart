...
class HistoryScreen extends StatelessWidget {
                          ...
                          child: Column(
                            ...
                            children:
                                snapshot.data!.docs.map((doc) {
                                  ...
                                  final itemName = data['item_name']?.toString() ?? 'Unnamed Item';
                                  final quantity = (data['quantity'] as num?)?.toInt() ?? 0;
                                  final timestamp = (data['createdAt'] as Timestamp?)?.toDate() ?? DateTime.now();
                                  final pickupTime = data['pickupTime']?.toString() ?? 'Flexible';
                                  final acceptorId = data['acceptorId']?.toString() ?? '';
  ...
  Widget _buildDonationCard(
    ...
    final acceptorId =
        data.containsKey('acceptorId') ? data['acceptorId']?.toString() : null;
